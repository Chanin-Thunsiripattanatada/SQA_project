import pytest
from TextRendering import FontFactory,TextRenderer,TextStyle,Font,SansSerifFont,SerifFont,MonospaceFont
...
def test_render_sans_serif(text_renderer):
...
def test_render_serif(text_renderer):
...
def test_render_monospace(text_renderer):
...
def test_render_unknown_font(text_renderer):
...
def test_render_with_line_spacing(text_renderer):
